                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="content">
                                <form action="UserController?flag=modifyUser&searchName=${sessionScope.condition.userName}&depID=${sessionScope.condition.depID}&pageNow=${requestScope.mpageNow}"
                                      method="post" onsubmit="return mouseclick()"
                                >
                                    <div class="row">
                                        <div class="col-md-5">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="userpower" class="form-control"
                                                        <c:if test="${sessionScope.user.userPower==0}">
                                                            onfocus="this.defaultIndex=this.selectedIndex;" onchange="this.selectedIndex=this.defaultIndex;" readonly
                                                        </c:if>    >
<%--                                                    <option value=1 selected="selected">超级管理员</option>--%>
<%--                                                    <option value=0>普通管理员</option>--%>
                                                        <c:choose>
                                                            <c:when test="${u2.userPower==1}" >
...
<%--                                                    <option class="form-control" value="6">爱尚纪律部</option>--%>
                                                    ...
                                                    <c:forEach items="${depMap}" var="item">
                                                       <c:choose>
                                                           <c:when test="${item.key==u2.depID}">
                                                               <option class="form-control" value="${item.key}" selected>${item.value}</option>--%>
                                                           </c:when>
                                                           <c:otherwise>
                                                               <option class="form-control" value="${item.key}" >${item.value}</option>--%>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <label>确认密码</label>
                                                <input type="password" class="form-control" placeholder="不能为汉字"
                                                       name="repassword" value="" id="repass" >

                                                <span id="errorrepass" style="color: red"></span>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                              ...
                                              <c:choose> 
                                                <c:when test="${u2.userSex=='男'}">
                                                    <input type="radio" checked="checked" name="usersex" value="男">男&nbsp&nbsp&nbsp&nbsp
                                                    <input type="radio" name="usersex" value="女">女
                                                </c:when>
                                                  <c:otherwise>
                                                      <input type="radio"  name="usersex" value="男">男&nbsp&nbsp&nbsp&nbsp
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>年龄</label>
                                                <input type="number" name="userage" class="form-control" value="${u2.userAge}"
                                    ...
                                    <button type="submit" class="btn btn-info btn-fill pull-right" id="moduserclick">修改</button>
...
<script>
    ...
    //4.整体验证 点击提交时触发
    <%--$("#moduserclick").click(function () {--%>
    <%--    $.ajax({--%>
    <%--        type:'post',--%>
    <%--        url:'${pageContext.request.contextPath}/ajax?flag=checkmoduser',--%>
    <%--        dataType:'text',--%>

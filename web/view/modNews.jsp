...
<body>
<div>${sessionScope.user.userPower}</div>
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="content">
                                ...
                                <form
                                        action="NewsController?flag=modNews&selclass=${param.selclass}&seltitle=${param.seltitle}&selstate=${param.selstate}&pageNow=${param.pageNow}" onsubmit="return myCheckTwo()"
                                        method="post" >
                                    ...
                                    <div>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label>新闻ID(默认)</label> <input type="text" name="id" placeholder="新闻id"
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <c:forEach items="${classMap}" var="item">
                                                    <c:choose>
                                                        <c:when test="${item.key==news.typeid}" >
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select
                                                        <c:if test="${sessionScope.user.userPower==0}">
                                                            onchange="this.selectedIndex=this.defaultIndex;"  onfocus="this.defaultIndex=this.selectedIndex;" readonly
                                                        </c:if>
                                                        onchange="fchange(${param.id})" class="form-control" name="f" id="f"
                                                >

                                                    <%--      <option value="-1" selected>请选择</option>--%>
                                                    <c:forEach items="${stateMap}" var="item">
                                                        <c:choose>
                                                            <c:when test="${item.key==news.flag}" >
                                                                <option value="${item.key}" selected>${item.value} </option>
                                                            </c:when>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>标题</label> <input type="text" name="title" ${sessionScope.user.userPower == 0 ?'':'readonly'}
...
<%--                                                                style="display: none"--%>
                                                ...
                                                <textarea rows="15" name="content" id="content"
                                                          class="form-control" placeholder="新闻正文...."

                                                          style="display:none"

                                                        <c:if test="${sessionScope.user.userPower==1}">readonly</c:if>
                                                ></textarea>

                                            </div>
                                        </div>
                                    </div>
                                <c:if test="${param.pd==null}">
